...
class FavouriteBooksAdapter(
...
) : RecyclerView.Adapter<FavouriteBooksAdapter.BestSellerViewHolder>() {

    private var fullDataList = ArrayList<lars_lion.dev.o_harid.network.response.favourite.Object>()
    ...
    fun updateList(list: List<lars_lion.dev.o_harid.network.response.favourite.Object>) {
        fullDataList.clear()
    ...
    constructor(
        ...
        fun bind(data: lars_lion.dev.o_harid.network.response.favourite.Object) {
            with(binding) {
                ...
                icDelete.visible(true)

                icDelete.setOnClickListener {
                    if (adapterPosition != RecyclerView.NO_POSITION)
                        listener.onDeleteItem(adapterPosition, data)
                }
