...
class SearchBooksAdapter(
...
) : RecyclerView.Adapter<SearchBooksAdapter.BestSellerViewHolder>() {

    private var fullDataList = ArrayList<lars_lion.dev.o_harid.network.response.search.Object>()
    ...
    fun updateList(list: List<lars_lion.dev.o_harid.network.response.search.Object>) {
        fullDataList.clear()
    ...
    constructor(
        ...
        fun bind(data: lars_lion.dev.o_harid.network.response.search.Object) {
            with(binding) {
